...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 bg-snap-darker relative overflow-hidden">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-96 h-96 bg-snap-purple/20 rounded-full blur-3xl" />
            <div className="absolute bottom-[-20%] right-[-10%] w-96 h-96 bg-snap-pink/20 rounded-full blur-3xl" />
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Share moments that matter</p>
                </div>
                ...
                <div className="glass rounded-3xl p-8">
                    ...
                    <p className="text-center text-gray-400 text-sm mt-6">
                        ...
                        <Link to="/register" className="text-snap-purple hover:text-snap-pink font-semibold transition-colors">
                            Sign Up
                        </Link>
                    </p>
                </div>
